...
type
    ...
    TAESCTR = class
    private
        function 	AddRoundKey(state: TCTRState; w: TCTRExpandedKey; rnd: Byte; Nb: Byte): TCTRState;
...
function TAESCTR.AddRoundKey(state: TCTRState; w: TCTRExpandedKey; rnd,
  Nb: Byte): TCTRState;
var
	r, c	: Integer;
begin
...
function TAESCTR.Cipher(input: TCTRMessage;
  w: TCTRExpandedKey): TCTRMessage;
var
	Nb,
    Nr			: Byte;
    state		: TCTRState;
...
begin
  ...
  repeat
    ...
    ExpandedKey[I + 4] := ExpandedKey[I] xor
      ...
      ((W2 shl 16) or (W2 shr 16)) xor ((W3 shl 24) or (W3 shr 8))) xor Rcon2[J];
    Inc(J);
