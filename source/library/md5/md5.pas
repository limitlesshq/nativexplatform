...
procedure Encode(Source, Target: pointer; Count: longword); inline;
var
	S: PByte;
	T: PDWORD;
	I: longword;
...
procedure Decode(Source, Target: pointer; Count: longword); inline;
var
	S: PDWORD;
	T: PByte;
	I: longword;
...
procedure Transform(Buffer: pointer; var State: MD5State); inline;
var
	a, b, c, d: DWORD;
	Block: MD5Block;
begin
